...
describe("PluginTimelineItemView", () => {
  it("keeps ordinary transcript content when no client renderer is installed", () => {
    ...
    expect(markup).toContain("Message before");
    expect(markup).toContain("Plugin timeline item unavailable.");
    expect(markup).toContain("Message after");
  });
